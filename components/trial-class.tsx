            ...
            {!submitted ? (
              <div>
                <div className='text-center'>
                  ...
                  >
                    Be the first to access new features. Enter your email below
                ...
                >
                  <input
                    ...
                    className='focus:shadow-outline w-full flex-1 appearance-none rounded-l-full border border-gray-300 bg-white px-4 py-2 leading-tight text-gray-700 focus:outline-none'
                    value={email}
                  ...
                  <motion.button
                    ...
                    className={`rounded-r-full bg-black px-6 py-[6px] text-white focus:outline-none ${isEmailValid ? 'cursor-pointer border border-zinc-300 hover:bg-opacity-90' : 'cursor-not-allowed'} ${!isEmailValid && 'border border-zinc-300'}`}
                  >
                    Join
                  </motion.button>
                </motion.form>
